...
const AddShop = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-green-100 min-w-screen">
      ...
      <div className="p-4 sm:p-8 bg-green-200 rounded-2xl shadow-xl border border-green-400 w-full max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="mt-8 bg-green-300 rounded-xl p-4 sm:p-6 border border-green-400 shadow-sm w-full">
