...
const NewOrders = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white min-w-screen">
      ...
      <div className="min-h-screen bg-green-100 py-8 w-full px-2 sm:px-0">
        <div className="max-w-5xl mx-auto p-4 sm:p-8 bg-green-200 rounded-2xl shadow-xl border border-green-400 w-full">
          ...
          {shops.map((shop, idx) => (
            <div
              key={idx}
              className="border border-green-300 rounded-2xl p-6 mb-8 shadow-lg bg-green-50"
            >
              ...
              <div className="mt-2 space-y-1">
                {shop.orders.map((order, i) => (
                  ...
                  >
                    ...
                    <span className="font-semibold">₹{order.debitAmount}</span>
                  </p>
                ))}
              </div>
              <div className="mt-6 bg-green-100 p-4 rounded-xl border border-green-200 shadow-sm">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleOrderChange(shop._id, "item", e.target.value)
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleOrderChange(shop._id, "debitAmount", e.target.value)
                  }
                  className="border border-green-400 p-3 mb-3 w-full rounded-lg bg-green-50 text-green-900 placeholder-green-700 focus:ring-2 focus:ring-green-400 focus:border-green-400 transition outline-none shadow-sm"
                />
                <button
